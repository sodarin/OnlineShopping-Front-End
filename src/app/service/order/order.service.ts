...
export class OrderService {
  ...
  orderItem1: OrderItem = new OrderItem('10000001', '联想ThinkPad X1 Carbon', 2, 24999, '../../../assets/img/e0ea6e25-c79b-4efd-b635-eca1c259ee53.jpg', ItemType.COMPUTER);
  orderItem2: OrderItem = new OrderItem('10000002', 'Apple MacBook Pro', 3, 21888, '../../../assets/img/f347d7f8-00f3-431a-aa8a-7a051995e5d8.jpg', ItemType.COMPUTER);
  orderItem3: OrderItem = new OrderItem('10000003', '外星人Alienware15.6英寸Gsync屏', 1, 20999, '../../../assets/img/1d34903f-2165-44ff-855a-9265bfa0f996.jpg', ItemType.COMPUTER);
  orderItem4: OrderItem = new OrderItem('10000004', '联想(Lenovo)小新14英寸', 4, 5099, '../../../assets/img/134ca0101fa57098.jpg', ItemType.COMPUTER);
  orderItem5: OrderItem = new OrderItem('20000001','华为(HUAWEI) Mate RS', 1, 10999, '../../../assets/img/5a6fc150-bd09-4169-ada2-595d85674c6a.jpg', ItemType.CELLPHONE);
  orderItem6: OrderItem = new OrderItem('20000001','华为(HUAWEI) Mate RS', 7, 10999, '../../../assets/img/5a6fc150-bd09-4169-ada2-595d85674c6a.jpg', ItemType.MOUSE);
  orderItem7: OrderItem = new OrderItem('20000001','华为(HUAWEI) Mate RS', 99, 10999, '../../../assets/img/5a6fc150-bd09-4169-ada2-595d85674c6a.jpg', ItemType.KEYBOARD);
  orderItem8: OrderItem = new OrderItem('20000001','华为(HUAWEI) Mate RS', 8, 10999, '../../../assets/img/5a6fc150-bd09-4169-ada2-595d85674c6a.jpg', ItemType.EARPHONE);
  orderItem9: OrderItem = new OrderItem('20000001','华为(HUAWEI) Mate RS', 895, 10999, '../../../assets/img/5a6fc150-bd09-4169-ada2-595d85674c6a.jpg', ItemType.CELLPHONE);
